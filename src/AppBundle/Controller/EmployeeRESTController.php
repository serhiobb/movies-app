...
class EmployeeRESTController extends VoryxController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $entities = $em->getRepository('AppBundle:Employee')->findBy($filters, $order_by, $limit, $offset);
            if ($entities) {
                return $entities;
            }
    ...
    {
        $entity = new Employee();
        $form = $this->createForm(get_class(new EmployeeType()), $entity, array("method" => $request->getMethod()));
